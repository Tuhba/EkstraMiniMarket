...
namespace EkstraMiniMarket
{
    public class Dukkan
    {
        ...
        public Dukkan()
        {
            this.DukkanAdi = "Super Market";
            this.DukkanAdresi = "Akçakoca";
